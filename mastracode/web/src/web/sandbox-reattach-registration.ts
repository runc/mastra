 ...
 * sandboxes through `@internal/mastracode/agents/sandbox-reattach`, but only
 * the web surface knows the sandbox provider factory — so the implementation
 * is registered here at web-surface load time.
 */
import { registerSandboxReattach as registerOnCore } from '@internal/mastracode/agents/sandbox-reattach';
